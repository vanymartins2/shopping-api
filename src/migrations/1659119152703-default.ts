...
export class default1659119152703 implements MigrationInterface {
    name = 'default1659119152703'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "messages" ("id" varchar PRIMARY KEY NOT NULL, "email" varchar NOT NULL, "message" varchar NOT NULL)`);
